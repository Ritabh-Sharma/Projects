...
void credits()
{
	...
	cprintf("%c",201);
	delay(700);
	xyprint(25,18," Phone: 04282-641282 (Resi.-Attur)",0,15);
	xyprint(25,19,"e-Mail: prabu_vasanth@yahoo.com",0,15);
	xyprint(25,20,"        cincoutprabu@yahoo.com",0,15);
	strcpy(str,"Hindusthan College of Engg. & Tech.,");
	l=strlen(str);
	c=1;
	t=1;
