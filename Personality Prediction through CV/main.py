...
class train_model:
    ...
    def train(self):
        ...
        self.mul = linear_model.LogisticRegression(multi_class='multinomial', solver='newton-cg',max_iter =1000)
        self.mul.fit(mainarray, train_y)
    ...
    def test(self, test_data):
        try:
            ...
            y_pred = self.mul.predict([test_predict])
            return y_pred
        except:
